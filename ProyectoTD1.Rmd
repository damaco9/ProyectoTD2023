...
=======
author: "Daniel Macho Collado, Paula Rodríguez Lanzas"
>>>>>>> 8ee9b53c3afb07f4240bddb9818ddb414d63db4d
date: "2023-04-19"
...
grafico1 <- ggplot(datos_fich_anal, aes(x = tiempo, y = fich_anal), color = 'azul') + 
  geom_line() +
  labs(x = 'Tiempo', y = 'Valor') +
  theme_bw() +
  scale_y_continuous(limits = c(-250, 1000), breaks = seq(-250, 1000, 250)) +
  scale_x_continuous(limits = c(0, 800), breaks = seq(0, 800, 2.5))
grafico1
...
datos_etiquetados <- data.frame(HR1, HR2, MHR, TOCO, SPO2, VCP, Ps, Pd, Pm)
